...
public class StatsActivity extends AppCompatActivity {
    ...
    private class GetTransactions extends AsyncTask<Integer, Void, ArrayList<Transaction>>{
        ...
        protected ArrayList<Transaction> doInBackground(Integer... integers) {
            try{
                ...
                }else{db.close(); cursor.close();return null;}
    ...
    private class GetLoans extends AsyncTask<Integer, Void, ArrayList<Loan>>{
        ...
        protected ArrayList<Loan> doInBackground(Integer... integers) {
            SQLiteDatabase db = databaseHelper.getReadableDatabase();
            Cursor cursor = db.query("loans", null,null,null,null,null,null,null);
            if(null != cursor){
                ...
                if(cursor.moveToFirst()){
                    ...
                    for(int i=0; i<cursor.getCount(); i++) {
                        ...
                        loan.setUser_id(cursor.getInt(cursor.getColumnIndex("transaction_id")));
                        ...
                        loan.setName(cursor.getString(cursor.getColumnIndex("finish_date")));
        ...
        protected void onPostExecute(ArrayList<Loan> loans) {
            ...
            if(null != loans)
            {
                ...
                pieChart.animateY(2500, Easing.EaseInOutCubic);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.menu_item_transaction:
                        Intent transactionIntent = new Intent(StatsActivity.this, LoanActivity.class);
                        transactionIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(transactionIntent);

                        break;
                    case R.id.menu_item_home:
                        Intent homeIntent = new Intent(StatsActivity.this, LoanActivity.class);
