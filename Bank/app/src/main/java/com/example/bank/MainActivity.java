...
import com.example.bank.Models.Shopping;
...
import com.example.bank.Authentication.LoginActivity;
import com.example.bank.Database.DatabaseHelper;
import com.example.bank.Dialogs.AddTransactionDialog;
import com.example.bank.Models.Shopping;
import com.example.bank.Models.Transaction;
import com.example.bank.Models.User;
        ...
        txtWelcome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(MainActivity.this)
                        .setTitle("Bank")
                        .setMessage("Created and Developed By Narayana Vasistha")
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.menu_item_transaction:
                        Intent transactionIntent = new Intent(MainActivity.this, LoanActivity.class);
        ...
        switch (item.getItemId()) {
            case R.id.menu_Bank:
                AlertDialog.Builder builder = new AlertDialog.Builder(this)
                        .setTitle("Bank")
                        .setMessage("Developed by Narayana Vasistha")
